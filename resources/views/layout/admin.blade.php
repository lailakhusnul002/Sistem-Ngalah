...
<head>
  ...
  <title>Monitoring Santri | Pondok Pesantren Ngalah</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{ asset('template/dist/img/NGALAH.png') }}" alt="NGALAH" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('template/dist/img/NGALAH.png') }}" alt="NGALAH" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Monitoring Santri</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('template/dist/img/avataruhuy.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
