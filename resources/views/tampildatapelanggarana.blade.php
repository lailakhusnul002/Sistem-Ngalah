...
<body>
    <h1 class="text-center mb-4">Edit Data Pelanggaran Asrama A</h1>
                        ...
                        <form action="/updatedatapelanggarana/{{ $datapelanggarana->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="jeniskelamin" aria-label="Default select example">
                                    <option selected>{{ $datapelanggarana->jeniskelamin }}</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pelanggaran" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $datapelanggarana->pelanggaran }}">
                            </div>
